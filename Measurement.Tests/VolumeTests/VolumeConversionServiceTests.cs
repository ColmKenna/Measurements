...
public class VolumeConversionServiceTests
{
    ...
    {
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.Liters).Amount;
    ...
    {
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.Milliliters).Amount;
        Assert.Equal(expectedResult, result, 6);
    }
    ...
    {
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.CubicMeters).Amount;
    ...
    {
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.CubicCentimeters).Amount;
                Assert.Equal(expectedResult, result, 6);
    }
    ...
    public void ConvertTo_CubicInches(decimal value, VolumeUnit fromUnit, decimal expectedResult)
    {
        ...
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.CubicInches).Amount;
    ...
    {
        var fromVolume = new Volume(fromUnit, value);
        var result = fromVolume.GetAs(VolumeUnit.CubicFeet).Amount;
        Assert.Equal(expectedResult, result, 7);
    }
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.Gallons).Amount;
    Assert.Equal(expectedResult, result, 6);
}
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.Quarts).Amount;
    Assert.Equal(expectedResult, result, 6);
}
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.USPints).Amount;
    Assert.Equal(expectedResult, result, 6);
}
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.FluidOunces).Amount;
    Assert.Equal(expectedResult, result, 6);
}
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.CubicYards).Amount;
...
{
    var fromVolume = new Volume(fromUnit, value);
    var result = fromVolume.GetAs(VolumeUnit.UKPints).Amount;
    Assert.Equal(expectedResult, result, 6);
}

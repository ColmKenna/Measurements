...
public class DurationConversionTests
{
    ...
    public void ConvertTo_WeeksToMonths_WithRemainder()
    {
        ...
        var expectedWeeks = 1; // Assuming a month is roughly 4 weeks
        var expectedDays = 4;
        var expected = Duration.Months(expectedMonths) + Duration.Weeks(1) + Duration.Days(expectedDays);
        Assert.Equal(expected, result);
    }
    ...
    public void ConvertTo_WeeksToYears_WithRemainder()
    {
        ...
        var expectedWeeks = 1;
        var expectedDays = 6; 
        var expected = Duration.Years(expectedYears) + Duration.Weeks(expectedWeeks) + Duration.Days(expectedDays);
        Assert.Equal(expected, result);
    }

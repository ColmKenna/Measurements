 ...
 public class WeightConversionServiceTests
    {
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Milligrams).Amount;
        ...
        public void ConvertTo_Grams(decimal value, WeightUnit fromUnit, decimal expectedResult)
        {
            ...
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Grams).Amount;
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Kilograms).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Pounds).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Ounces).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.MetricTons).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.Stones).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
        ...
        {
            var fromWeight = new Weight(fromUnit, value);
            var result = fromWeight.GetAs(WeightUnit.USTons).Amount;
            Assert.Equal(expectedResult, result, 5);
        }
    }
...
public class DistanceConversionServiceTests
{
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Millimeters).Amount;
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Centimeters).Amount;
    ...
    public void ConvertTo_Meters(decimal value, DistanceUnit fromUnit, decimal expectedResult)
    {
        ...
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Meters).Amount;
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Kilometers).Amount;
    ...
    [InlineData(1, DistanceUnit.Kilometers, 39370.078740157)]
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Inches).Amount;
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Feet).Amount;
        Assert.Equal(expectedResult, result, 2);
    }
    ...
    {
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Yards).Amount;
        Assert.Equal(expectedResult, result, 2);
    }
    ...
    public void ConvertTo_Miles(decimal value, DistanceUnit fromUnit, decimal expectedResult)
    {
        ...
        var fromDistance = new Distance( fromUnit,value);
        var result = fromDistance.GetAs(DistanceUnit.Miles).Amount;
        Assert.Equal(expectedResult, result, 5);
    }
}
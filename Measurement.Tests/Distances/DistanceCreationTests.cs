...
public class DistanceCreationTests
{
    ...
    public void CreateMillimetersTest()
    {
        ...
        Assert.Equal(5, distance.GetAs(DistanceUnit.Millimeters).Amount );
    }
    ...
    public void CreateCentimetersTest()
    {
        ...
        Assert.Equal(10, distance.GetAs(DistanceUnit.Centimeters).Amount);
    }
    ...
    public void CreateMetersTest()
    {
        ...
        Assert.Equal(1, distance.GetAs(DistanceUnit.Meters).Amount);
    }
    ...
    public void CreateKilometersTest()
    {
        ...
        Assert.Equal(2, distance.GetAs(DistanceUnit.Kilometers).Amount);
    }
    ...
    public void CreateInchesTest()
    {
        ...
        Assert.Equal(12, distance.GetAs(DistanceUnit.Inches).Amount);
    }
    ...
    public void CreateFeetTest()
    {
        ...
        Assert.Equal(3, distance.GetAs(DistanceUnit.Feet).Amount);
    }
    ...
    public void CreateYardsTest()
    {
        ...
        Assert.Equal(4, distance.GetAs(DistanceUnit.Yards).Amount);
    }
    ...
    public void CreateMilesTest()
    {
        ...
        Assert.Equal(5, distance.GetAs(DistanceUnit.Miles).Amount);
    }
}
